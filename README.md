...
# 优化
* index.html
  * \views\images\pizzeria.jpg 太大，浪费资源，进行了图片优化压缩 
  * <link href="css/print.css" rel="stylesheet"> 改为 <link href="css/print.css" media="print" rel="stylesheet">
  * js脚本移动到代码底部加载执行
  * 注释掉网络字体
  * 使用内联CSS

* \views\js\main.js
  * 修改 changeSliderLabel()方法;
  * 修改 updatePositions()方法;
  * querySelectorAll  修改为 document.getElementsByClassName();
  * querySelector  修改为 document.getElementById();
