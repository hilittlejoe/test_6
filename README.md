本项目是一个简单的，个人项目展示页面
1、主界面，请使用打开  index.html
2、css文件夹内含有两个css文件，print.css是打印界面时，网页的显示格式。style.css是主css文件
3、img文件夹内是主界面以及在mobile界面显示的时候，使用的图片
4、views文件夹内是一个项目的展示页面
5、其他HTML文件是主页面上子项目的链接文件。
