...
var resizePizzas = function(size) {
  ...
  function changeSliderLabel(size) {
  	var pizzaSize_qs = document.getElementById("pizzaSize");
    switch(size) {
      case "1":
        pizzaSize_qs.innerHTML = "Small";
        return;
      case "2":
        pizzaSize_qs.innerHTML = "Medium";
        return;
      case "3":
        pizzaSize_qs.innerHTML = "Large";
        return;
      default:
  ...
  function changePizzaSizes(size) {
  	var randomPizzaContainer_qs = document.getElementsByClassName("randomPizzaContainer");
