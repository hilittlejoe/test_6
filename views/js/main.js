...
var myPizzaSize = document.getElementById("pizzaSize");
...
function changePizzaSizes(size) {
  var myRandomPizzaContainer = document.getElementsByClassName("randomPizzaContainer");
  var newwidth = sizeSwitcher(size);

  for (var i = 0; i < myRandomPizzaContainer.length; i++) {
    myRandomPizzaContainer[i].style.width = newwidth;
  }
}
